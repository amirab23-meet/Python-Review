...
video = create_youtube_video("minions movie leaked" , "fun video")
for i in range(496):
    video = like(video)
video = dislike(video)
...
v1 = create_youtube_video("minions movie leaked" , "fun video")
v2 = create_youtube_video("yyyyeeeeeeeeeesssss" , "noooooooooo")
v1["hashtag"] = hasht()
v2["hashtag"] = hasht()
